...
<div class="navbar-header">
  ...
  <tr>
    ...
    <td width="298"> <table width="300" height="1">
    <tr>
     <td width="200"><?php echo $row_consulta_usuario['user']; ?></td>
  </tr>
</table>
    <p>&nbsp;<a href="<?php echo $logoutAction ?>">
    <img src="imagenes/05.jpg.png" width="25" height="21">
    <FONT SIZE=3 ace="Comic Sans MS" color="#FF0000">
    <B>Cerrar Sesión</B></FONT></a></td>
    ...
    <ul id="carousel">
  <li><img width="497" height="342" src="imagenes/01.png" /></li>
  <li><img width="500" height="300" src="imagenes/02.png" /></li>
  <li><img width="502" height="312" src="imagenes/01.png" /></li>
  <li><img width="500" height="300" src="imagenes/02.png" /></li>
</ul>	
</section>
</body>
