...
<div class="navbar-header">
  ...
  <tr>
    ...
    <td width="360"> <a href="#"><FONT SIZE=5 ace="Comic Sans MS"><B>Categorias </B></FONT></a></td>
    <td width="298"> <table width="300" height="1">
  <tr>
    <td width="51"><strong><FONT SIZE=5 ace="Comic Sans MS" color="#000099"><B>Usuario:</strong></B></FONT></td>
	...
	<?php
		...
		$re=mysql_query("select * from productos where nombre = 'Chamarra'")or die(mysql_error());
